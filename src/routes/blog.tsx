      ...
      <header className="pt-32 pb-20">
        <div className="term">
          <div className="term-bar">
            ...
            <span className="dot" />
            <span className="dot" />
            <span className="title">alpe@dev: ~/blog</span>
          </div>
          <div className="term-body">
            <div className="prompt-line">
              <span className="u">alpe@dev</span>:~/blog$ ls -la ./posts
            </div>
            <p className="bio">
              total 0 · the old posts have been <span className="hl">rm -rf</span>'d on purpose. New writing is
              compiling, slowly, between naps (the baby's and mine).
            </p>
            <p className="bio">
              Stay tuned. Meanwhile, have a <span className="hl-c">fortune</span>:
            </p>

            <div className="prompt-line mt-8">
              <span className="u">alpe@dev</span>:~/blog$ fortune
            </div>
            <blockquote
