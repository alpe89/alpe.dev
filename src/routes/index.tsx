...
const processes = [
  { pid: '001', name: 'dad.service', cpu: 98, uptime: 'since 2026-04-29', stat: 'S+ (sleepless)' },
  { pid: '002', name: 'typescript.d', cpu: 71, uptime: '9 years', stat: 'R (running)' },
  { pid: '003', name: 'espresso.io', cpu: 64, uptime: 'daily', stat: 'D (dependent)' },
  { pid: '004', name: 'jvm.hotspot', cpu: 66, uptime: 'since Mollie', stat: 'W (still warming up)' },
  { pid: '005', name: 'arch.initiatives', cpu: 53, uptime: 'quarterly', stat: 'D (drawing boxes & arrows)' },
  { pid: '006', name: 'shiba.watchdog', cpu: 42, uptime: '5 years', stat: 'S (very good boy)' },
      ...
      <header className="py-20">
        <div className="term">
          <div className="term-bar">
            ...
            <span className="dot" />
            <span className="dot" />
            <span className="title">alpe@dev: ~</span>
          </div>
          <div className="term-body">
            <div className="prompt-line">
              <span className="u">alpe@dev</span>:~${' '}
              ...
              <div className="flex flex-col-reverse gap-7 sm:flex-row sm:items-start">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="bio">
                    ...
                    production, payments stop. No pressure. Full-stack <span className="hl-c">TypeScript</span>{' '}
                    enthusiast. Yes, that's my whole personality. Based in Milan, fueled by espresso and existential
                    dread.
                  </p>
                  <p className="bio">
                    Married to someone way out of my league. Dad since <span className="hl">April 29th</span>. Proud
                    Shiba Inu parent: I like dogs more than humans, which is a completely reasonable opinion once you've
                    met both.
                  </p>
                  <div className="keys">
                ...
                <div className="shrink-0 text-center">
                  <img
                    className="block h-[132px] w-[132px] rounded-lg border border-(--border) shadow-[0_0_24px_-6px_var(--glow-soft)]"
                    src="/avatar.png"
