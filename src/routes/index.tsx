  ...
  return (
    <main className="wrap">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="role">
                    ...
                    <span className="flags">
                      [can lead humans, prefers dogs]
                    </span>
                  </div>
                  <p className="bio">
                    I move money for a living at{" "}
                    <span className="hl">Mollie</span>, which means when I break
                    things in production, payments stop. No pressure. Full-stack{" "}
                    <span className="hl-c">TypeScript</span> enthusiast. Yes,
                    that's my whole personality. Based in Milan, fueled by
                    espresso and existential dread.
                  </p>
                  <p className="bio">
                    Married to someone way out of my league. Dad since{" "}
                    <span className="hl">April 29th</span>. Proud Shiba Inu
                    parent: I like dogs more than humans, which is a completely
                    reasonable opinion once you've met both.
                  </p>
                  <div className="keys">
                    press <kbd>⌘K</kbd> to navigate · <kbd>↑↑↓↓←→←→BA</kbd> if
                    you know, you know
                  </div>
                </div>
      ...
      <section className="section" id="blog">
        ...
        <p className="bio">
          Blog rebooted. Old posts archived, new ones compiling. In the
          meantime,{" "}
      ...
      <section className="section" id="connect">
        ...
        <div className="connect">
          ...
          <a
            className="conn"
            href="https://www.linkedin.com/in/albertopertusi/"
            target="_blank"
            rel="noreferrer"
          >
